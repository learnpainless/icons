...
window.addEventListener('load', (event) => {
  ...
  detectAdblock().then((res) => {
    ...
    if (blocked) {
      ...
      detector.innerHTML = '<div id="adblockbyspider"><div class="inner"> <div class="header"> <center><img style="clear: both; text-align: center;" border="0" data-original-height="260" data-original-width="260" src="/aab/app.png" alt="Learn Pain Less"></center> <h2>Ad Blocker Detected :(</h2> </div> <div class="isi"> <p>Please consider supporting us by disabling your ad blocker.</p><p>Please Disable your adblocker and Refresh the page to view the site content.</p><div><br></div>  <div class="spideradblock"></div> </div> </div> </div>'
